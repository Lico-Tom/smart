...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='猪栏状态表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='猪栏表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='猪栏饲料表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='猪饲料品牌表';
...
CREATE TABLE IF NOT EXISTS `t_pig_feed_price` (
   ...
   `day` datetime NULL DEFAULT NULL COMMENT '天'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='猪饲料价格表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='猪饲料总表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='猪饲料表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='猪体温表';
...
CREATE TABLE IF NOT EXISTS `t_pig_weight` (
   ...
   `detection_time` datetime NULL DEFAULT NULL COMMENT '称重时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='猪的称重表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='mqtt地址表';
...
CREATE TABLE IF NOT EXISTS `t_mqtt_sub` (
   ...
   `detection_time` datetime NULL DEFAULT NULL COMMENT '创建时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='mqtt订阅主题表';
...
CREATE TABLE IF NOT EXISTS `t_mqtt_pub` (
   ...
   `detection_time` datetime NULL DEFAULT NULL COMMENT '创建时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='mqtt发布主题表';
...
CREATE TABLE IF NOT EXISTS `t_mqtt_history` (
    ...
    `detection_time` datetime NULL DEFAULT NULL COMMENT '创建时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='mqtt历史记录表';
